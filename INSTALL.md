First, you must put a The Legend of Zelda: A Link to the Past and Four Swords (USA) ROM (with SHA1: `a272055abbbf6c26b0cd54c87395d01699589161`) in the root directory of the repository and name it `baserom.gba`. 
...
To set up the repository:
	...
	git clone https://github.com/jiangzhengwenjz/alttpafs
	git clone https://github.com/jiangzhengwenjz/agbcc -b new_newlib_pret

	cd ./agbcc
	sh build.sh interwork
	sh install.sh ../alttpafs

	cd ../alttpafs

To build **alttpafs.gba**:
